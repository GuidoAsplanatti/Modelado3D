            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="relative aspect-square rounded-2xl overflow-hidden shadow-arch-lg group">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#0369a1] to-[#0284c7] opacity-20 blur-2xl group-hover:opacity-40 transition-opacity duration-700"></div>
                ...
                <div className="space-y-4 text-base text-slate-700 leading-relaxed">
                  ...
                  <div className="pt-6 flex flex-wrap items-center gap-4">
                    ...
                    <div className="flex items-center gap-3 ml-2">
                      <a href="https://www.linkedin.com/in/asplanattiguido/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-[#0369a1] hover:text-white transition-all duration-300">
                        <Linkedin className="w-5 h-5" />
                      </a>
                      <a href="https://www.behance.net/guidoasp/projects" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-[#0369a1] hover:text-white transition-all duration-300">
                      ...
                      <a href="https://github.com/GuidoAsplanatti" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-[#0369a1] hover:text-white transition-all duration-300">
